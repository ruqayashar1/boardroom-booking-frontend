...
//       <div id="all-boardrooms" className="p-4 flex space-x-14 justify-center">
//         <div
//           id="boardroom-card-1"
//           className="flex items-start p-6  max-w-sm bg-white rounded-xl shadow-md space-x-4"
//         >
//           <img
...
const BoardRooms = () => {
  return (
    <section id="boardrooms" className="flex justify-center items-center min-h-screen bg-gray-100">
      <div className="w-full max-w-6xl p-4">
        <BoardroomFilterPopup />
        <div id="all-boardrooms" className="p-4 flex flex-wrap justify-center gap-8">
          <div
            id="boardroom-card-1"
            className="flex items-start p-6 max-w-sm bg-white rounded-xl shadow-md space-x-4"
          >
